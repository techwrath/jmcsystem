    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="top-panel">
          ...
          <p>Please fill the following form to edit a brand</p>
        </div>
        ...
        @csrf
          <div class="row">
            ...
            <div class="col-auto w-25">
                <input type="text" class="form-control" id="brandName" name="brandName" value="{{ old('brandName', $brand->brandName) }}" required>
            </div>
           </div>
           <br>
          <div class="mb-3 w-50">
            <label for="brandDescription" class="form-label">Brand Description: *</label>
            <textarea class="form-control" id="brandDescription" name="brandDescription" rows="5" maxlength="1000" required>{{ old('brandDescription', $brand->brandDescription) }}</textarea>
          </div>
          <div class ="row">
          @if($brand->brandLogo)
            <div style="margin-top: 10px;">
                <label>Current Brand Logo:</label>
                <img src="{{ asset('dist/img/' . $brand->brandLogo) }}" alt="Brand Logo" style="width:100px; height:100px;">
            </div>
          @endif
          </div>
          <div class="row">
            ...
            <div class="col-auto w-25">
            <input class="form-control" type="file" id="brandLogo" name="brandLogo" accept="dist/img/*" value="{{ old('brandLogo', $brand->brandLogo) }}">
            </div>
           </div>
