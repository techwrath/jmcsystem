...
<div id="page-wrapper">
              ...
              <div class="card-header">
                <div class="row">
                 ...
                 <p>DataTable to view, add , edit and delete orders.</p>
                 </div>
                 <div class="col-md-6 align-items-center">
                  <a role="button" href="{{route('add.order')}}" class="btn btn-secondary float-right d-inline-block d-flex align-items-center" id="">Add New Order</a>
                </div>
                </div>
            </div>
              <!-- /.card-header -->
