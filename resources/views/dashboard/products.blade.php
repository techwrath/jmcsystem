    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="top-panel">
          ...
          <p>Please fill the following form to add a new product</p>
        </div>
        ...
        @csrf
         <div class="row">
          ...
          <div class="row">
           ...
           <div class="row">
              <div class="col-auto">
                  <label for="productType" class="col-form-label">Product Type: * &nbsp</label>
              </div>
                <div class="col-auto w-25">
                    <select class="form-control" name="productType" id="productType" style="-webkit-appearance: listbox !important;" placeholder="Select Product" required>
           ...
           <div class="row">
            ...
            <div class="col-auto">
                <label for="inputField" class="col-form-label">Weight of Bag: *</label>
            </div>
            <div class="col-auto w-25">
                <input type="number" class="form-control" id="weightOfBag" name="weightOfBag" required>
            </div>
          ...
          <div class="mb-3 w-50">
            ...
            <textarea class="form-control" id="productDescription" name="productDescription" rows="5" maxlength="1000" required></textarea>
          </div>
          <div class="row">
            <div class="col-auto">
                <label for="inputField" class="col-form-label">Product Image: *</label>
            </div>
            <div class="col-auto w-25">
            <input class="form-control" type="file" id="productImage" name="productImage" accept="dist/img/*" required>
            </div>
           </div>
