...
<head>
    ...
    .dataTables_wrapper {
    overflow: visible !important; /* Ensures wrapper doesn't cause overflow */
}

.dataTables_scrollBody {
    overflow: visible !important; /* Ensures body doesn't cause overflow */
}
...
<div id="page-wrapper">
              ...
              <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                 <h4 class="mb-0">REQUISITION FORMS</h4>
                 <p>DataTable to view, add , edit and delete requisition forms.</p>
                 </div>
                 <div class="col-md-6 align-items-center">
                  <a role="button" href="{{route('requisition.form')}}" class="btn btn-secondary float-right d-inline-block d-flex align-items-center" id="">Add New Form</a>
                </div>
                </div>
            </div>
              <!-- /.card-header -->
